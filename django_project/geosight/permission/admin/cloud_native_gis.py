...
from geosight.permission.models import (
    ...
    CloudNativeGISLayerUserPermission,
    CloudNativeGISLayerGroupPermission
)
...
class UserPermissionInline(admin.TabularInline):
    ...
    model = CloudNativeGISLayerUserPermission
    extra = 0
...
class GroupPermissionInline(admin.TabularInline):
    ...
    model = CloudNativeGISLayerGroupPermission
    extra = 0
...
admin.site.register(CloudNativeGISLayerPermission, PermissionAdmin)
