...
from geosight.permission.models import (
    ReferenceLayerViewPermission, ReferenceLayerViewUserPermission,
    ReferenceLayerViewGroupPermission
)
...
class UserPermissionInline(admin.TabularInline):
    ...
    model = ReferenceLayerViewUserPermission
    extra = 0
...
class GroupPermissionInline(admin.TabularInline):
    ...
    model = ReferenceLayerViewGroupPermission
    extra = 0
...
admin.site.register(ReferenceLayerViewPermission, PermissionAdmin)
