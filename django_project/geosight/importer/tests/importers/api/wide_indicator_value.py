...
from geosight.importer.importers import IndicatorValueApiWideFormat
...
class SharepointWideFormatIndicatorValueTest(BaseApiIndicatorValueTest):
    """Test for Importer : Api Wide Format Indicator Value."""
    ...
    def test_correct_importer(self):
        """Test if correct importer."""
        self.assertEqual(
            self.importer.importer, IndicatorValueApiWideFormat
        )
