...
from geosight.importer.importers.csv_request._base import (
    BaseCSVRequestFormatImporter
)


class SDMXIndicatorValueFormat(
    BaseCSVRequestFormatImporter, IndicatorValueLongFormat
):
    ...
    def attributes_definition(**kwargs) -> List[ImporterAttribute]:
        ...
        return BaseCSVRequestFormatImporter.attributes_definition(
