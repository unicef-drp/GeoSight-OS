...
from geosight.importer.importers.excel import IndicatorValueExcelWideFormat
from ._base import BaseSharepointFormatImporter


class IndicatorValueSharepointExcelWideFormat(
    BaseSharepointFormatImporter,
    IndicatorValueExcelWideFormat,
    IndicatorValueWideFormat
):
    """Import data from sharepoint in wide format for indicator value."""

    description = "Import Related Table data from sharepoint in long format."
