...
class ScheduledJobListView(RoleContributorRequiredMixin, AdminBaseView):
    """Scheduled Jobs Lost View."""

    template_name = 'frontend/admin/importer/scheduled_jobs.html'
