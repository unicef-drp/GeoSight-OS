...
class ImporterLogDataView(RoleContributorRequiredMixin, AdminBaseView):
    """ImporterLog Data View."""

    template_name = 'frontend/admin/importer/log_data.html'
    ...
    def get_context_data(self, **kwargs) -> dict:
        ...
        context['obj_type'] = self.log.importer.import_type
        context['obj_status'] = self.log.status
        return context
