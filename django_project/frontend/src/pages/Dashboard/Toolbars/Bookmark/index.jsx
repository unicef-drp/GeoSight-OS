...
export default function Bookmark({ map }) {
  ...
  const bookmarkSave = bookmarks
    ? bookmarks.find((row) => row.id === saveBookmarkID)
    : null;
      ...
      {enabled && (
        <CustomPopover
          ...
          Button={
            <div
              className="Active"
              data-tool={Variables.DASHBOARD.TOOL.SPATIAL_BOOKMARK}
            >
                      ...
                      {bookmarks.map((bookmark) => {
                        return (
                          <tr
                            ...
                            onClick={() => {
                              dispatch(
                                Actions.SelectedBookmark.change(bookmark),
                              );
                            }}
                          >
                            <td>
                            ...
                            bookmark.id &&
                            (user.is_staff ||
                              user.username === bookmark.creator) ? (
                              <Fragment>
                                <td>
                                  <EditIcon
                                    className="EditIcon"
          ...
          >
            ...
            <ModalFooter>
              <SaveButton
                ...
                disabled={!name || !projectCheckpointEnable || uploading}
              />
            </ModalFooter>
          </Modal>
        </CustomPopover>
