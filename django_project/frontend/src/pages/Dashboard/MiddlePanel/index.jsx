 ...
 * Left panel.
 */
export default function MiddlePanel({ leftContent, rightContent }) {
  ...
  return (
    <>
      ...
      <div
        className={
          "BottomContent " + (globalDateSelectorOpened ? "DateOpen" : "")
        }
      >
        <div className="ContentLine">
          <div className="LeftSection">
            <div className="ContentLine Inner" id="tilt-control"></div>
            <div
              className="ContentLine Inner"
              id="maplibregl-ctrl-bottom-left"
            ></div>
            <div className="ContentLine Inner">
              <Basemaps />
              <div className="Disclaimer Fullscreen">
