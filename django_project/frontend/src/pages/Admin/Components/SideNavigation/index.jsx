...
import NotificationMaintenance from "../../../../components/NotificationMaintenance";
  ...
  return (
    <div className={"SideNavigation " + (minified ? "Minified" : "")}>
          ...
          <Fragment>
            <div className="SideNavigationContentGroup">
              ...
              >
                <a
                  ...
                  className={
                    "SideNavigation-Row " +
                    (pageName === pageNames.Dashboard ? "active" : "")
                  }
                >
              ...
              <SidaNavigationButton
                minified={minified}
                title={t("admin.indicators")}
              >
                <a
                  href={indicatorList}
                  className={
                    "SideNavigation-Row " +
                    (pageName === pageNames.Indicators ? "active" : "")
                  }
                >
                  <ListIcon />
                  <span className="SideNavigation-Row-Name">
              ...
              <SidaNavigationButton
                minified={minified}
                title={t("admin.contextLayers")}
              >
                <a
                  href={contextLayerList}
                  className={
                    "SideNavigation-Row " +
                    (pageName === pageNames.ContextLayer ? "active" : "")
                  }
                >
                  ...
                  <span className="SideNavigation-Row-Name">
                    {t("admin.contextLayers")}
                  </span>
                </a>
              </SidaNavigationButton>
              <SidaNavigationButton
                minified={minified}
                title={t("admin.basemaps")}
              >
                <a
                  href={basemapList}
                  className={
                    "SideNavigation-Row " +
                    (pageName === pageNames.Basemaps ? "active" : "")
                  }
                >
              ...
              >
                <a
                  ...
                  className={
                    "SideNavigation-Row " +
                    (pageName === pageNames.Styles ? "active" : "")
                  }
                >
            ...
            <div className="SideNavigationContentGroup">
              ...
              <div className="SideNavigation-Row-Group">
                ...
                >
                  <a
                    href={urls.admin.dataManagement}
                    className={
                      "SideNavigation-Row " +
                      ([pageNames.Importer, pageNames.DataManagement].includes(
                        pageName,
                      )
                        ? "active"
                        : "")
              ...
              <SidaNavigationButton
                minified={minified}
                title={t("admin.dataBrowser")}
              >
                <a
                  href={dataset}
                  className={
                    "SideNavigation-Row " +
                    (pageName === pageNames.Dataset ? "active" : "")
                  }
                >
              ...
              <SidaNavigationButton
                minified={minified}
                title={t("admin.relatedTables")}
              >
                <a
                  href={relatedTableList}
                  className={
                    "SideNavigation-Row " +
                    ([
                      pageNames.RelatedTables,
                      pageNames.RelatedTablesData,
                    ].includes(pageName)
                      ? "active"
                      : "")
                  }
            ...
            {user.is_admin && localReferenceDatasetEnabled ? (
              <div className="SideNavigationContentGroup">
                <div className="SideNavigationContentGroupTitle">
                  {t("admin.referenceDatasets")}
                </div>
                <SidaNavigationButton
                  minified={minified}
                  title={t("admin.referenceDatasetsLower")}
                >
                  <a
                    href={referenceDatasetList}
                    className={
                      "SideNavigation-Row " +
                  ...
                  >
                    ...
                    <span className="SideNavigation-Row-Name">
                      {t("admin.referenceDatasetsLower")}
                    </span>
                  </a>
                </SidaNavigationButton>
                <SidaNavigationButton
                  minified={minified}
                  title={t("admin.importers")}
                >
                  <a
                    href={referenceDatesetImporterList}
                    className={
                      "SideNavigation-Row " +
            ...
            <div className="SideNavigationContentGroup">
              ...
              {user.is_admin ? (
                <Fragment>
                  <SidaNavigationButton
                    minified={minified}
                    title={t("admin.usersAndGroups")}
                  >
                    <a
                      href={userAndGroupList}
                      className={
                        "SideNavigation-Row " +
                        (pageName === pageNames.UsersAndGroups ? "active" : "")
                      }
                    >
              ...
              <div className="SideNavigation-Row-Group">
                <SidaNavigationButton
                  minified={minified}
                  title={t("admin.accessRequest")}
                >
                  <a
                    href={urls.admin.accessRequest}
                    className={
                      "SideNavigation-Row " +
                      (pageNames.AccessRequestList === pageName ? "active" : "")
                    }
                  >
                    <GppMaybeIcon className="SideNavigation-Row-Icon" />
                    <span className="SideNavigation-Row-Name">
                      {t("admin.accessRequest")}
                    </span>
                    <NotificationBadge />
                  </a>
                </SidaNavigationButton>
            ...
            <div className="SideNavigation-Row-Group">
              ...
              >
                <a
                  ...
                  className={
                    "SideNavigation-Row " +
                    (pageNames.UserProfile === pageName ? "active" : "")
                  }
                >
      ...
      <div className="SideNavigationContentGroup ViewAllDashboard">
        <SidaNavigationButton
          minified={minified}
          title={t("admin.viewAllDashboards")}
        >
          <a href="/" className="SideNavigation-Row Button">
            <GridIcon />
            <span className="SideNavigation-Row-Name">
              {t("admin.viewAllDashboards")}
            </span>
          </a>
        </SidaNavigationButton>
