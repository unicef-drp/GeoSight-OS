 ...
 * Access Request List
 */
export function AccessRequestPermissionList({ ...props }) {
 ...
 * Access Request List
 */
export function AccessRequestUserList({ ...props }) {
  return <AdminListContent
    columns={[
      { field: 'id', headerName: 'id', hide: true },
      {
...
export default function AccessRequestList({ defaultTab }) {
  return <MultipleAdminContent
    ...
    contents={{
      'New User': <AccessRequestUserList/>,
      'Permission Request': <AccessRequestPermissionList/>,
    }}
  />
}
