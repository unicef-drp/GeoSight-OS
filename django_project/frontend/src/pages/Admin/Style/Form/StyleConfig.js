    ...
    <Fragment>
      {selectableInput ? (
        <div className="BasicFormSection">
          <FormControlLabel
            ...
            onChange={(evt) => {
              selectableInputState["style_config_enable"] =
                !selectableInputStateOutput("style_config_enable")[0];
      ...
      {selectableInputStateOutput("style_config_enable")[1] ? (
        <Fragment>
          ...
          {/* Style from library. */}
          <div hidden={!dynamicStyleTypes.includes(data.style_type)}>
            <DynamicStyleConfig data={data} setData={setData} />
          </div>
        </Fragment>
      ) : null}
    </Fragment>
