...
export function IndicatorLayerConfig({
  ...
  return (
    <Fragment>
      ...
      >
        <ModalHeader onClosed={onClosed}>Add new indicator layer</ModalHeader>
        <ModalContent>
          <div
            className={
              "ModalSelection-Option " +
              (indicators.length > 0 ? "Enabled" : "")
            }
            onClick={() => {
          ...
          >
            ...
            <div className="helptext">
              Select 2 or more indicators and turn all of it as single indicator
              layer.
            </div>
          </div>
          <div
            className={
              "ModalSelection-Option " +
              (relatedTables.length > 0 && referenceLayer.identifier
                ? "Enabled"
                : "")
            }
            onClick={() => {
          ...
          <div
            className={
              "ModalSelection-Option " + (indicators.length ? "Enabled" : "")
            }
            onClick={() => {
...
export default function IndicatorLayersForm() {
  ...
  // Config modal
  const [indicatorDataSelectionOpen, setIndicatorDataSelectionOpen] =
    useState(false);
  const [indicatorLayerConfigOpen, setIndicatorLayerConfigOpen] =
    useState(false);
    ...
    <Fragment>
      <ListForm
        ...
        addLayerAction={(layer, group) => {
          dispatch(
            Actions.IndicatorLayers.add(indicatorToIndicatorLayer(layer)),
          );
        }}
