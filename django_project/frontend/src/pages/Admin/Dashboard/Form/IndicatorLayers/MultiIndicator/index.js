...
const chartTypes = [defaultChartType, "Bar"];
                ...
                Style: (
                  <div>
                        ...
                        data.indicators = items.map((item) => {
                          if (!item.override_style) {
                            const indicator = indicators.find(
                              (indicator) => indicator.id === item.id,
                            );
                            if (indicator) {
                    ...
                    <div className="IndicatorsStyle">
                                  ...
                                  switch (evt.target.value) {
                                    case FixedSize:
                                      data.chart_style = {
                                        ...
                                        size: data.chart_style.size
                                          ? data.chart_style.size
                                          : 10,
                                      };
                                      break;
                                    default:
                                      data.chart_style = {
                                        ...data.chart_style,
                                        sizeType: evt.target.value,
                                        minSize: data.chart_style.minSize
                                          ? data.chart_style.minSize
                                          : defaultMinSize,
                                        maxSize: data.chart_style.maxSize
                                          ? data.chart_style.maxSize
                                          : defaultMaxSize,
                                      };
                                  }
                                  updateData();
                      ...
                      <div>
                        <div>
                          <b className="light">Symbol Size</b>
                        </div>
                        <br />
                        {data.chart_style.sizeType === FixedSize ? (
                          <Fragment>
                            <table>
                              <tbody>
                                <tr>
                                  <td>
                                    <input
                                      min={defaultMinSize}
                                      type="number"
                                      value={data.chart_style.size}
                                      onChange={(evt) => {
                                        data.chart_style.size = parseFloat(
                                          evt.target.value,
                                        );
                                        updateData();
                                      }}
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <input
                                      ...
                                      onChange={(evt) => {
                                        data.chart_style.minSize = parseFloat(
                                          evt.target.value,
                                        );
                                        if (
                                          data.chart_style.maxSize <
                                          ...
                                          data.chart_style.maxSize = parseFloat(
                                            data.chart_style.minSize,
                                          );
                                        }
                                        updateData();
