...
import { BaseSharepointForm } from "./base";
import { BaseWideExcelIndicatorValue } from '../Base/WideExcelIndicatorValue'
 ...
 */
export const SharepointWideExcelIndicatorValue = forwardRef(
  ({
