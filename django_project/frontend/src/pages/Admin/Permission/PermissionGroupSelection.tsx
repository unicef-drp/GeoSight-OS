...
import GroupSelector from "../../../components/ResourceSelector/GroupSelector";
...
interface Props {
  setData: (permission: string, objects: Group[]) => void;
  permissionChoices: string[];
}

export function PermissionGroupSelection(
  {
