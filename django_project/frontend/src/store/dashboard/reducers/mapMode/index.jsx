...
export const MAP_MODE_ACTION_TYPE_COMPARE_ACTIVE = 'MAP_MODE/COMPARE_ACTIVE';
export const MAP_MODE_ACTION_TYPE_COMPARE_INACTIVE = 'MAP_MODE/COMPARE_INACTIVE';
...
export default function mapCompareModeReducer(state = initialState, action) {
  if (action.name === MAP_MODE_ACTION_NAME) {
    switch (action.type) {
      ...
      case MAP_MODE_ACTION_TYPE_COMPARE_ACTIVE: {
        return {
          ...state,
          compareMode: true
        }
      }
      case MAP_MODE_ACTION_TYPE_COMPARE_INACTIVE: {
        return {
          ...state,
          compareMode: false
        }
