...
export default function LayerDescription({ layer }) {
  ...
  return (
    <div
      className={
        "LayerInfoIcon InfoIcon LayerIcon" + (layer?.error ? " Error" : "")
      }
    >
      {layer?.error ? (
        <CustomPopover
          ...
          Button={<InfoFillIcon fontSize={"small"} />}
          showOnHover={true}
        >
          <div className="LayerInfoPopover">{"" + layer.error}</div>
        </CustomPopover>
      ) : (
        <CustomPopover
          anchorOrigin={{
                ...
                <Fragment>
                  {layerType === LAYER_TYPE_INDICATOR ? (
                    <div>
                      ...
                      {loadedData.last_update
                        ? formatDateTime(
                            new Date(loadedData.last_update),
                            false,
                            true,
                          )
                        : "-"}
