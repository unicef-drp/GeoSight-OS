...
export { default as StarOnIcon } from "./star-on.svg";
export { default as StarOffIcon } from "./star-off.svg";
...
export { default as DataBrowserIcon } from "./data-browser.svg";
export { default as DataBrowserActiveIcon } from "./data-browser-active.svg";
export { default as DataManagementIcon } from "./data-management.svg";
export {
...
export { default as GraphUncheckedIcon } from "./graph-unchecked.svg";
...
export { default as LabelOffIcon } from "./label-off.svg";
export { default as LabelOnIcon } from "./label-on.svg";
export { default as LayerActiveIcon } from "./layer-active.svg";
export { default as LeftPanelCheckedIcon } from "./left-panel-checked.svg";
export { default as LeftPanelUncheckedIcon } from "./left-panel-unchecked.svg";
...
export { default as ProjectActiveIcon } from "./project-active.svg";
export { default as RemoveIcon } from "./remove.svg";
export { default as ShareIcon } from "./share.svg";
export { default as ShrinkIcon } from "./shrink.svg";
export { default as SortAscIcon } from "./sort-ascending.svg";
export { default as SortDescIcon } from "./sort-descending.svg";
export { default as StyleIcon } from "./style.svg";
export { default as StyleActiveIcon } from "./style-active.svg";
...
export { default as ChainOnIcon } from "./chain-on.svg";
export { default as ChainOffIcon } from "./chain-off.svg";
...
export { default as TimeUncheckedIcon } from "./time-unchecked.svg";
