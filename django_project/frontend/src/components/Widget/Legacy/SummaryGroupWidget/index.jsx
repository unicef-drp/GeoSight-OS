 ...
 */
export default function Index({ data, widgetData }) {
        ...
        case WidgetOperation.SUM:
          ...
          data.forEach(function (rowData) {
            ...
            if (property_2 === "geometry_code") {
              ...
              for (const [level, geometriesLevel] of Object.entries(
                geometries,
              )) {
            ...
            <table>
              ...
              <tbody>
                {sorted.map((value, index) => (
                  <tr key={index}>
                    <td>{value[0]}</td>
                    <td>{numberWithCommas(value[1].value)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
