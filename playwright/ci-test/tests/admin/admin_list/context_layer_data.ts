...
test.describe('Context layer cloud native data', () => {
  ...
  test('Context layer related table data', async ({ page }) => {
    ...
    await expect(page.locator('.MuiDataGrid-columnHeader').nth(9)).toHaveText("TestText")
    await expect(page.locator('.MuiDataGrid-columnHeader').nth(10)).toHaveText("Longitude")
    ...
    await expect(page.locator('.MuiDataGrid-row').nth(0).locator('.MuiDataGrid-cell').nth(9)).toHaveText("Can't find it")
    await expect(page.locator('.MuiDataGrid-row').nth(0).locator('.MuiDataGrid-cell').nth(10)).toHaveText("43.53291619493366")
  })
})