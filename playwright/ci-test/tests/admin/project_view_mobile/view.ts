...
test.describe('View project', () => {
  const assert = async (
    ...
    await page.locator('.LegendToggler').click();
    ...
    // TODO
    //  We fix this as it is visibility toggler
    ...
    //  Need to fix the UI
    // await toMap();
    // const config = page.locator('#RelatedTableLayerMiddleConfigReal')
    // await config.getByRole('combobox', { name: 'Select 1 option' }).click();
    // await config.getByRole('option', { name: 'Blank' }).click();
    // await expect(lastLog).toEqual(assertLogs[1]);
    //
    // await config.getByRole('option', { name: 'HEALTH' }).click();
    // await expect(lastLog).toEqual(assertLogs[2]);
    //
    // await config.getByRole('option', { name: 'EDU' }).click();
    // await expect(lastLog).toEqual(assertLogs[3]);
    //
    // await config.getByRole('option', { name: 'WASH' }).click();
